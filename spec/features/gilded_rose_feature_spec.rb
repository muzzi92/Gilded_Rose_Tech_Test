...
describe GildedRose do
    ...
    context 'When it is a standard item' do
      ...
      before(:each) do
        @standard_item = StandardItem.new(name="+5 Dexterity Vest", sell_in=10, quality=20)
    ...
    context 'When the item is Aged Brie' do
      ...
      before(:each) do
        @brie = Brie.new(name="Aged Brie", sell_in=2, quality=1)
    ...
    context 'When the item is Sulfuras' do
      ...
      before(:each)do
        @sulfuras = Sulfuras.new(name="Sulfuras, Hand of Ragnaros", sell_in=1, quality=80)
    ...
    context 'When the item is Backstage Pass' do
      ...
      it 'Decreases sell_in by 1' do
        pass = Pass.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=15, quality=20)
      ...
      it 'Increases quality by 2 when sell_in is 5 or more' do
        pass = Pass.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=7, quality=20)
        shop = GildedRose.new([pass])
        shop.update_quality
      ...
      it 'Increases quality by 3 when sell_in is 0 or more' do
        pass = Pass.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=2, quality=20)
        shop = GildedRose.new([pass])
        shop.update_quality
      ...
      it 'Quality is 0 when sell_in is below 0' do
        pass = Pass.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=0, quality=20)
        shop = GildedRose.new([pass])
        shop.update_quality
      ...
      it 'Quality never rises above 50' do
        pass_two = Pass.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=15, quality=50)
